...
<p class="d-flex justify-content-center mt-5" style="font-family: BMJUA; font-size: 30px;">이곳에서 자신이 쓴 글을 수정할 수 있습니다.</p>

<div class="container mt-5">
<h3 class="text-center color3" style="margin-bottom: -35px;">A.BOARD</h3>
<div class="table-users" style="max-width:1400px; margin-bottom:100px; z-index: 1; background: #FFFFFF; padding: 45px; text-align: center; box-shadow: rgba(0, 0, 0, 0.05) 0px 0px 0px 1px, rgb(209, 213, 219) 0px 0px 0px 1px inset; ">
