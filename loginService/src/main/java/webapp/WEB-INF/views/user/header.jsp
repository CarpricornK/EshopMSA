			...
			<c:choose>
				...
				<c:otherwise>
					<ul class="nav nav-tabs">
						...
						<li class="nav-item"><a class="nav-link" href="../productpageindex">제품목록</a></li>
						<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Shopping</a>
							<div class="dropdown-menu">
								<a class="dropdown-item" href="/board/ProductsaveForm">상품등록</a> 
								<a class="dropdown-item" href="../productfavorite">나의 쇼핑/관리자</a>
							</div></li>
						<li class="nav-item"><a class="nav-link"></a></li>
					</ul>
				</c:otherwise>
