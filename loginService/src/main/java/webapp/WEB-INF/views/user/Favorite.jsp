...
<p class="d-flex justify-content-center mt-5" style="font-family: BMJUA; font-size: 30px;">즐겨찾기 목록</p>

<div class="text-center pt-1" style="margin-top:50px; font-family: 'Baloo Da 2', cursive; font-size:20px; color: tomato; height:40px; width:80%; margin-left:10%; margin-right:10%; background-color: #222222; border-radius: 5px;">RECIPE</div>
<br/>
...
<div class="text-center pt-1" style="font-family: 'Baloo Da 2', cursive; font-size:20px; color: tomato; box-shadow: 1px 1px 3px 1px #dadce0; height:40px; width:80%; margin-left:10%; margin-right:10%; background-color: #222222; border-radius: 5px;">BOARD</div>
<br/>
...
<div class="text-center pt-1" style="margin-top:100px; font-family: 'Baloo Da 2', cursive; font-size:20px; color: tomato; box-shadow: 1px 1px 3px 1px #dadce0; height:40px; width:80%; margin-left:10%; margin-right:10%; background-color: #222222; border-radius: 5px;">R.BOARD</div>
<br/>
